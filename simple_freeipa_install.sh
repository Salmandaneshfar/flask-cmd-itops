...
# مرحله 1: تنظیم متغیر محیطی برای نادیده گیری SSL
print_step "1" "تنظیم متغیر محیطی..."
...
# مرحله 3: حذف تنظیمات ناقص
print_step "3" "حذف تنظیمات ناقص..."
...
# مرحله 4: تنظیم hostname و hosts
print_step "4" "تنظیم hostname و hosts..."
...
# مرحله 7: نصب FreeIPA با نادیده گیری SSL
print_step "7" "نصب FreeIPA با نادیده گیری SSL..."
PYTHONHTTPSVERIFY=0 ipa-server-install \
  --domain=mci.local \
  --realm=MCI.LOCAL \
...
print_step "8" "راه‌اندازی سرویس‌ها..."
...
# مرحله 9: صبر برای آماده شدن
print_step "9" "صبر برای آماده شدن سرویس‌ها..."
sleep 60

# مرحله 10: بررسی وضعیت
print_step "10" "بررسی وضعیت سرویس‌ها..."
systemctl status ipa --no-pager -l
echo ""

# مرحله 11: ایجاد کاربر MCI
print_step "11" "ایجاد کاربر MCI..."
ipa user-add mci \
  --first=MCI \
  --last=User \
  --email=mci@mci.local \
...
# مرحله 12: دادن دسترسی ادمین به MCI
print_step "12" "دادن دسترسی ادمین به MCI..."
ipa group-add-member admins --users=mci
print_success "دسترسی ادمین به MCI داده شد"

# مرحله 13: تست اتصال
print_step "13" "تست اتصال..."
...
# مرحله 14: بررسی پورت‌ها
print_step "14" "بررسی پورت‌ها..."
