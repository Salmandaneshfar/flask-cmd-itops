...
echo "=== نصب صحیح بسته‌های FreeIPA ==="
...
dnf remove -y ipa-server ipa-server-dns pki-ca pki-tomcat freeipa-server freeipa-server-dns 2>/dev/null || true
...
# مرحله 7: نصب FreeIPA از AppStream
print_step "7" "نصب FreeIPA از AppStream..."
dnf install -y @idm:DL1
print_success "بسته‌های FreeIPA از AppStream نصب شدند"

# مرحله 8: نصب بسته‌های اضافی
print_step "8" "نصب بسته‌های اضافی..."
dnf install -y freeipa-server freeipa-server-dns
print_success "بسته‌های اضافی نصب شدند"
...
# مرحله 12: بررسی PATH
print_step "12" "بررسی PATH..."
echo "PATH: $PATH"
echo ""

# مرحله 13: تست دستور
print_step "13" "تست دستور ipa-server-install..."
