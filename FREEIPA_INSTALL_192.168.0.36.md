# راهنمای نصب FreeIPA روی Red Hat 8.10 - IP: 192.168.0.36

## 🎯 تنظیمات مخصوص سرور شما

### اطلاعات سرور:
- **IP Address:** 192.168.0.36
- **نام دامنه پیشنهادی:** ipa.local (یا دامنه خودتان)
- **نام میزبان:** ipa.local
- **Realm:** LOCAL
...
# تنظیم نام میزبان
sudo hostnamectl set-hostname ipa.local

# اضافه کردن به /etc/hosts
echo "192.168.0.36 ipa.local ipa" | sudo tee -a /etc/hosts
```
