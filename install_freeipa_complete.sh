...
echo "=== نصب و پیکربندی کامل FreeIPA ==="
...
# مرحله 1: توقف سرویس‌های قبلی
print_step "1" "توقف سرویس‌های قبلی..."
...
# مرحله 2: حذف تنظیمات ناقص
print_step "2" "حذف تنظیمات ناقص..."
