...
print_step "1" "بررسی وضعیت فعلی..."
echo "=== وضعیت سرویس ipa ==="
systemctl status ipa --no-pager -l
echo ""

# مرحله 2: بررسی فایل‌های پیکربندی
print_step "2" "بررسی فایل‌های پیکربندی..."
echo "=== محتویات /etc/ipa/ ==="
ls -la /etc/ipa/ 2>/dev/null || echo "پوشه /etc/ipa/ وجود ندارد"
echo ""

# مرحله 3: توقف سرویس‌ها
print_step "3" "توقف سرویس‌ها..."
...
# مرحله 4: حذف تنظیمات ناقص
print_step "4" "حذف تنظیمات ناقص..."
